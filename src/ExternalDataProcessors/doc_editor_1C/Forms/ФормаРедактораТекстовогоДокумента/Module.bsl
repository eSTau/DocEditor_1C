...
&НаКлиенте
Функция КонтекстМодуляОбъекта(МодульОбъекта, ТипыБлоковМодуля)
	...
	Для Каждого Блок Из БлокиМодуля Цикл
		...
		ИначеЕсли Блок.ТипБлока = ТипыБлоковМодуля.НачалоОбласти Тогда
			...
			Блок.ОписаниеБлока.ИмяРаздела = ТекущийРаздел;
			Блок.ОписаниеБлока.ИмяОбласти = ТекущаяОбласть;
...
Функция ДанныеБлокаМодуля()
	...
	ДанныеБлока.ОписаниеБлока.Вставить("ИмяРаздела", "");
	ДанныеБлока.ОписаниеБлока.Вставить("ИмяОбласти", "");
