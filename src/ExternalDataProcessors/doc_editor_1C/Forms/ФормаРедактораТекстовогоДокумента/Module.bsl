...
//	РедактируемыйДокумент = РедактируемыйДокумент + Символ(10) + БлокОписанияОбъекта.ПолучитьТекст();
...
Процедура ДобавитьОписаниеПолейОбъекта(МенеджерПолей)
	...
	Для Каждого Поле Из МенеджерПолей.ПолучитьЭлементы() Цикл
		...
		ДобавитьВТабилцуСтрокуОписанияСвойства(Поле.Имя, ПредставлениеТипа, Поле.Описание);
...
&НаКлиенте
Процедура ДобавитьВТабилцуСтрокуОписанияСвойства(Имя, Тип, Описание)
