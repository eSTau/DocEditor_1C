...
Функция СвойстваСправочника(ИмяСправочника)
	...
	СвойстваСправочника.Модули.Добавить("Справочник." + ИмяСправочника + ".МодульОбъекта.txt", "Модуль объекта");
	СвойстваСправочника.Модули.Добавить("Справочник." + ИмяСправочника + ".МодульМенеджера.txt", "Модуль менеджера");
