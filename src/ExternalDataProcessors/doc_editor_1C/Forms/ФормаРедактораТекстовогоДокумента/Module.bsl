	...
	Для Каждого Элемент Из МенеджерЭлементов.ПолучитьЭлементы() Цикл
		...
		Если ЗначениеЗаполнено(Элемент.Свойства) Тогда
			Для Каждого Свойство Из Элемент.Свойства Цикл
				...
				Иначе
					ПредставлениеСвойств = ПредставлениеСвойств 
						+ Свойство.Ключ + ": " + Свойство.Значение;
				КонецЕсли;
			КонецЦикла;

			ОписаниеЭлемента = "";
			Если Свойство.Свойство("Опиание") Тогда
			Если ЗначениеЗаполнено(Свойство.Описание.Комментарий) Тогда
				ОписаниеЭлемента = ОписаниеЭлемента + Свойство.Описание.КомментарийК
			КонецЕсли;
			
			Если ЗначениеЗаполнено(Свойство.Описание.Пояснение) Тогда
				ОписаниеЭлемента = ОписаниеЭлемента + " " + Свойство.Описание.Пояснение;
			КонецЕсли;
			КонецЕсли;
		КонецЕсли;
		
		ДанныеНовойСтроки.Добавить(Свойство.Имя);
