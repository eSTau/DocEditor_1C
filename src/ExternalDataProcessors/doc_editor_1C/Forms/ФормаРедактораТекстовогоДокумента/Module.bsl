...
Процедура ДобавитьОписаниеКонтекстаМодуля(КонтекстМодуля, ПредставлениеМодуля)
	...
	Для Каждого БлокМодуля Из КонтекстМодуля Цикл
		...
		Если Не БлокМодуля.ОписаниеБлока.ВозвращаемыеЗначения = Неопределено 
			Или Не ПустаяСтрока(БлокМодуля.ОписаниеБлока.ПроизвольноеОписаниеВозвращаемыеЗначения) Тогда
		...
		Если Не ПустаяСтрока(БлокМодуля.ОписаниеБлока.Примеры) Тогда
			...
			БлокОписанияПримера = БлокОписанияПримера 
				+ ДокументБлокПереносСтроки() + БлокМодуля.ОписаниеБлока.Примеры;
		...
		Если Не ПустаяСтрока(БлокМодуля.ОписаниеБлока.Назначение) Тогда
			...
			БлокОписанияМетода = БлокОписанияМетода 
				+ ДокументБлокПереносСтроки() + БлокМодуля.ОписаниеБлока.Назначение;
...
Процедура ДобавитьОписаниеСинтексисаМетода(ОписаниеМетода)
	...
	ДокументДобавитьСодержание(
		...
		ОписаниеМетода.Экспортный, " - экспортный метод", ""));
