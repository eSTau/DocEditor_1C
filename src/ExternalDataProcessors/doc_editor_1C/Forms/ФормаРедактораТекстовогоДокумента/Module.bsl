...
//  
&НаКлиенте
Функция БлокиПрограммногоМодуля(МодульОбъекта)
...
Функция ТипыБлоковМодуля()
	...
	ТипыБлоковМодуля.Вставить("ЗаголовокПроцедуры", "ЗаголовокПроцедуры");
	ТипыБлоковМодуля.Вставить("ОкончаниеПроцедуры", "ОкончаниеПроцедуры");
	ТипыБлоковМодуля.Вставить("ЗаголовокФункции", "ЗаголовокФункции");
	ТипыБлоковМодуля.Вставить("ОкончаниеФункции", "ОкончаниеФункции");
