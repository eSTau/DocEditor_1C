...
Процедура СтруктураМетаданныхПередРазворачиванием(Элемент, Строка, Отказ)
	...
	Если ПодчиненныеЭлементыОбъекта.Количество() = 1 Тогда
		Если ПодчиненныеЭлементыОбъекта[0].Класс = "СлужебныйУзел" Тогда
			...
			ДобавитьПодчиненныеОбъектыМенеджераКлассаМетаданных(
		...
		ИначеЕсли ПодчиненныеЭлементыОбъекта[0].Класс = "СлужебныйУзелДанныхОбъекта" Тогда
			ПодчиненныеЭлементыОбъекта.Очистить();
			ДобавитьДанныеОбъектаМетаданных(
...
Процедура ДобавитьОбщиеКлассыОбъектовМетаданных()
	...
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ОбщиеМодули", "ОбщийМодуль", "Общие модули");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ПараметрыСеанса", "ПараметрСеанса", "Параметры сеанса");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "Роли", "Роль", "Роли");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ОбщиеРеквизиты", "ОбщийРеквизит", "Общие реквизиты");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ПланыОбмена", "ПланОбмена", "Планы обмена");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "КритерииОтбора", "КритерийОтбора", "Критерии отбора");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ПодпискиНаСобытия", "ПодпискаНаСобытие", "Подписки на события");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "РегламентныеЗадания", "РегламентноеЗадание", "Регламентные задания");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ФункциональныеОпции", "ФункциональнаяОпция", "Функциональные опции");
	ДобавитьНовыйКлассМенеджераОбъектов(
		ЭлементОбщие, "ПараметрыФункциональныхОпций", "ПараметрФункциональнойОпции", "Параметры функциональных опций");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ОпределяемыеТипы", "ОпределяемыйТип", "Определяемые типы");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ХранилищаНастроек", "ХранилищеНастроек", "Хранилища настроек");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ОбщиеФормы", "ОбщаяФорма", "Общие формы");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ОбщиеКоманды", "ОбщаяКоманда", "Общие команды");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ГруппыКоманд", "ГруппаКоманд", "Группы команд");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "Интерфейсы", "Интерфейс", "Интерфейсы");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ОбщиеМакеты", "ОбщийМакет", "Общие макеты");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ОбщиеКартинки", "ОбщаяКартинка", "Общие картинки");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "ПакетыXDTO", "ПакетXDTO", "XDTO-пакеты");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "WebСервисы", "WebСервис", "Web-сервисы");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "HTTPСервисы", "HTTPСервис", "HTTP-сервисы");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "WSСсылки", "WSСсылка", "WS-ссылки");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "Стили", "Стиль", "Стили");
	ДобавитьНовыйКлассМенеджераОбъектов(ЭлементОбщие, "Языки", "Язык", "Языки");
...
Процедура ДобавитьКлассыПрикладныхОбъектов()
	...
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "Константы", "Константа", "Константы");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "Справочники", "Справочник", "Справочники");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "Документы", "Документ", "Документы");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "ЖурналыДокументов", "ЖурналДокументов", "Журналы документов");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "Перечисления", "Перечисление", "Перечисления");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "Отчеты", "Отчет", "Отчеты");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "Обработки", "Обработка", "Обработки");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "ПланыВидовХарактеристик", "ПланВидовХарактеристик", "Планы видов характеристик");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "ПланыСчетов", "ПланСчетов", "Планы счетов");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "ПланыВидовРасчета", "ПланВидовРасчета", "Планы видов расчета");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "РегистрыСведений", "РегистрСведений", "Регистры сведений");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "РегистрыНакопления", "РегистрНакопления", "Регистры накопления");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "РегистрыБухгалтерии", "РегистрБухгалтерии", "Регистры бухгалтерии");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "РегистрыРасчета", "РегистрРасчета", "Регистры расчета");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "БизнесПроцессы", "БизнесПроцесс", "Бизнес-процессы");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "Задачи", "Задача", "Задачи");
	ДобавитьНовыйКлассМенеджераОбъектов(СтруктураМетаданных, "ВнешниеИсточникиДанных", "ВнешнийИсточникДанных", "Внешние источники данных");
	
КонецПроцедуры // ДобавитьКлассыПрикладныхОбъектов()

&НаСервере
Процедура ДобавитьНовыйКлассМенеджераОбъектов(ЭлементРодитель, ИмяМенеджераКласса, ИмяКласса, СинонимКласса)
...
&НаСервере
Процедура ДобавитьПодчиненныеОбъектыМенеджераКлассаМетаданных(ИдентификаторЭлементаРодителя, ИмяМенеджераКласса, ИмяКласса)	
...
Процедура ДобавитьПодчиненныеЭлементыМенеджераКлассаДокумент(ЭлементМенеджерКласса)
	...
	Если ЭлементМенеджерКласса.Класс = "Документ" И ЭлементМенеджерКласса.МенеджерОбъектов Тогда
		ДобавитьНовыйКлассМенеджераОбъектов(ЭлементМенеджерКласса, "НумераторыДокументов", "НумераторДокументов", "Нумераторы");
		ДобавитьНовыйКлассМенеджераОбъектов(ЭлементМенеджерКласса, "Последовательности", "Последовательность", "Последовательности");
	КонецЕсли;
...
&НаСервере
Процедура ДобавитьДанныеОбъектаМетаданных(ИдентификаторЭлементаРодителя, ИмяМенеджераКласса, ИмяОбъекта)
	...
	Если ДанныеОбъекта.Графы Тогда
		ДобавитьГрафыОбъектаМетаданных(ЭлементОбъектМетаданных, ОбъектМетаданных);
	КонецЕсли;
...
Функция СвойстваПланаВидовХарактеристик(ИмяПланаВидовХарактеристик)
	...
	Для Каждого ТипПланаВидовХарактеристик Из ОписаниеТипов Цикл
		...
		ПредставлениеТипов = ПредставлениеТипов + СтрЗаменить(ТипЗначения(ТипПланаВидовХарактеристик), "_", "\_");
	КонецЦикла;
...
Процедура ДобавитьОписаниеПодчиненныхОбъектовВДокумент(ОбъектМетаданныхСтруктуры, МенеджерЭлементов)
	...
	Для Каждого Элемент Из МенеджерЭлементов.ПолучитьЭлементы() Цикл
		...
		ПредставлениеТипа = СтрЗаменить(ПредставлениеТипаЭлемента(Элемент), "_", "\_");
...
Функция СвойстваИзмерения(ИмяМенеджераОбъекта, ИмяОбъектаРодителя, ИмяИзмерения)
	...
	СвойстваИзмерения.Вставить("ГруппаОсновные", "Основноей");
