...
//	ТекущийОбъект = СтруктураМетаданных.НайтиПоИдентификатору(Строка);
//	ПодчиненныеЭлементыОбъекта = ТекущийОбъект.ПолучитьЭлементы();
...
//			ДобавитьПодчиненныеОбъектыМетаданныхТест(Строка, ТекущийОбъект.Имя, ТекущийОбъект.Класс);
//		КонецЕсли;
//	КонецЕсли;
...
&НаСервере
Процедура ДобавитьПодчиненныеОбъектыМетаданныхТест(ИдентификаторЭлементаРодителя, ИмяМенеджераКласса, ИмяКласса)	
	...
	СвойстваОбъекта = ДанныеИспользуемыеОбъектомМетаданных(ИмяМенеджераКласса);
	ОбъектыМетаданных = Метаданные[ИмяМенеджераКласса];
	ЭлементыРодительскогоУзла = СтруктураМетаданных
		.НайтиПоИдентификатору(ИдентификаторЭлементаРодителя).ПолучитьЭлементы();
