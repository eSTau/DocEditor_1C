...
Процедура ДобавитьОписаниеОбъектаПоШаблону()
	...
	ДобавитьОписаниеПодчиненныхОбъектов(ОбъектМетаданных.ПолучитьИдентификатор(), БлокОписанияОбъекта);
...
&НаСервере
Процедура ДобавитьОписаниеПодчиненныхОбъектов(ИдентификаторОбъекта, БлокОписанияОбъекта)
	
	ОбъектМетаданных = СтруктураМетаданных.НайтиПоИдентификатору(ИдентификаторОбъекта);
