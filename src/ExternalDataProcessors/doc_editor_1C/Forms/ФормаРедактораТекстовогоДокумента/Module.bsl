...
Процедура ДобавитьПодчиненныеЭлементыМенеджераКлассаДокумент(ЭлементМенеджерКласса)
	...
	Если ЭлементМенеджерКласса.Класс = "Документ" И ЭлементМенеджерКласса.МенеджерОбъектов Тогда
		ДобавитьМенеджерКлассаОбъектов(ЭлементМенеджерКласса, "НумераторыДокументов", "НумераторДокументов",
			"Нумераторы");
		ДобавитьМенеджерКлассаОбъектов(ЭлементМенеджерКласса, "Последовательности", "Последовательность",
			"Последовательности");
	КонецЕсли;
...
Процедура УстановитьИконкуОбъектаМетаданных(ЭлементОбъектаМетаданных)
	...
	ИначеЕсли (ЭлементОбъектаМетаданных.Класс = "МодульОбычногоПриложения" Или ЭлементОбъектаМетаданных.Класс = "МодульУправляемогоПриложения"
		Или ЭлементОбъектаМетаданных.Класс = "МодульВнешнегоСоединения" Или ЭлементОбъектаМетаданных.Класс
		= "МодульСеанса") Тогда
...
Процедура НастроитьКомандыКонтекстногоМеню(ОбъектМетаданных)
	...
	Если Не (ЭтоСлужебныйЭлемент(ОбъектМетаданных) Или ЭтоОбщийУзелКонфигурации(ОбъектМетаданных)) Тогда
	...
	Если Не (ОбъектМетаданных.МенеджерОбъектов Или ЭтоСлужебныйЭлемент(ОбъектМетаданных)) Тогда
...
Функция ЭтоЭлементУзлаОбщие(ОбъектМетаданных)
	...
	Возврат ОбъектМетаданных.Класс = "ПланОбмена" Или ОбъектМетаданных.Класс = "КритерийОтбора"
		Или ОбъектМетаданных.Класс = "ПакетXDTO" Или ОбъектМетаданных.Класс = "WebСервис" Или ОбъектМетаданных.Класс
		= "HTTPСервис";
...
Функция ЭтоОбщийУзелКонфигурации(ОбъектМетаданных)
	...
	Возврат ОбъектМетаданных.Класс = "Конфигурация" Или ОбъектМетаданных.Класс = "МодульОбычногоПриложения"
		Или ОбъектМетаданных.Класс = "МодульУправляемогоПриложения" Или ОбъектМетаданных.Класс = "МодульВнешнегоСоединения"
		Или ОбъектМетаданных.Класс = "МодульСеанса" Или ОбъектМетаданных.Класс = "Общие";
...
Функция ЭтоСлужебныйЭлемент(ОбъектМетаданных)
	...
	Возврат ОбъектМетаданных.Класс = "Буфер" Или ОбъектМетаданных.Класс = "Расширения";
...
Функция ЭтоПрикладнойОбъект(ОбъектМетаданных)
	...
	Возврат ОбъектМетаданных.Класс = "ПланОбмена" Или ОбъектМетаданных.Класс = "КритерийОтбора"
		Или ОбъектМетаданных.Класс = "Справочник" Или ОбъектМетаданных.Класс = "Константа" Или ОбъектМетаданных.Класс = "Документ"
		Или ОбъектМетаданных.Класс = "ЖурналДокументов" Или ОбъектМетаданных.Класс = "Перечисление"
		Или ОбъектМетаданных.Класс = "Отчет" Или ОбъектМетаданных.Класс = "Обработка" Или ОбъектМетаданных.Класс = "ПланВидовХарактеристик"
		...
		Или ОбъектМетаданных.Класс = "БизнесПроцесс" Или ОбъектМетаданных.Класс = "Задача" Или ОбъектМетаданных.Класс
...
Функция ОбъектИмеетПрограммныйМодульОбъекта(ОбъектМетаданных)
	...
	Возврат ОбъектМетаданных.Класс = "ОбщийМодуль" Или ОбъектМетаданных.Класс = "КритерийОтбора"
		Или ОбъектМетаданных.Класс = "Справочник" Или ОбъектМетаданных.Класс = "Константа" Или ОбъектМетаданных.Класс = "Документ"
		Или ОбъектМетаданных.Класс = "ЖурналДокументов" Или ОбъектМетаданных.Класс = "Перечисление"
		Или ОбъектМетаданных.Класс = "Отчет" Или ОбъектМетаданных.Класс = "Обработка" Или ОбъектМетаданных.Класс = "ПланВидовХарактеристик"
		Или ОбъектМетаданных.Класс = "ПланСчетов" Или ОбъектМетаданных.Класс = "ПланВидовРасчета"
...
Функция ЭтоОбъектСсылочногоТипа(ОбъектМетаданных)
	...
	Возврат ОбъектМетаданных.Класс = "ПланОбмена" Или ОбъектМетаданных.Класс = "Справочник" Или ОбъектМетаданных.Класс
		= "Документ" Или ОбъектМетаданных.Класс = "Перечисление" Или ОбъектМетаданных.Класс = "ПланВидовХарактеристик"
		Или ОбъектМетаданных.Класс = "ПланСчетов" Или ОбъектМетаданных.Класс = "ПланВидовРасчета"
...
Функция ЭтоПодчиненныеЭлементыОбъекта(ПодчиненныйЭлемент)
	...
	Возврат ПодчиненныйЭлемент.Класс = "Граф" Или ПодчиненныйЭлемент.Класс = "Измерение" Или ПодчиненныйЭлемент.Класс = "Ресурс"
		Или ПодчиненныйЭлемент.Класс = "Реквизит" Или ПодчиненныйЭлемент.Класс = "РеквизитАдресации"
		Или ПодчиненныйЭлемент.Класс = "ПризнакУчета" Или ПодчиненныйЭлемент.Класс = "ПризнакУчетаСубконто"
		Или ПодчиненныйЭлемент.Класс = "Значение" Или ПодчиненныйЭлемент.Класс = "Форма" Или ПодчиненныйЭлемент.Класс = "Команда"
...
Процедура ДокументДобавитьБлокНазначение(СвойстваОбъекта)
	...
	Если Не ЗначениеЗаполнено(СвойстваОбъекта.Описание.Комментарий) И Не ЗначениеЗаполнено(
		СвойстваОбъекта.Описание.Пояснение) Тогда
		Возврат;
	КонецЕсли;
...
Процедура ЗаполнитьСвойстваОбъектаМетаданных(ОбъектМетаданныхСтруктуры)
	ОбъектМетаданныхСтруктуры.Свойства = СвойстаОбъектаМетаданных(ОбъектМетаданныхСтруктуры.Имя,
		ОбъектМетаданныхСтруктуры.Класс);
КонецПроцедуры
...
Функция ПредставлениеСвойстваОбъекта(ЗначениеСвойства)
	...
	ИначеЕсли ТипЗнч(ЗначениеСвойства) = Тип("СписокПолей") Тогда
		...
		КонецЦикла;
	ИначеЕсли ТипЗнч(ЗначениеСвойства) = Тип("КоллекцияЗначенийСвойстваОбъектаМетаданных") Или ТипЗнч(ЗначениеСвойства)
		= Тип("СоставПланаОбмена") Тогда
...
Функция ПредставлениеТипа(ТипМетаданных)
	...
	Если ТипМетаданных = Тип("Число") Или ТипМетаданных = Тип("Строка") Или ТипМетаданных = Тип("Булево")
		Или ТипМетаданных = Тип("Дата") Или ТипМетаданных = Тип("ХранилищеЗначения") Или ТипМетаданных = Тип(
		"ПостроительОтчета") Или ТипМетаданных = Тип("ВидСравнения") Или ТипМетаданных = Тип("Отбор") Или ТипМетаданных
		= Тип("ПоляНастройки") Или ТипМетаданных = Тип("НаправлениеСортировки") Тогда
...
&НаКлиенте
Процедура ВыполнитьКомандуКонфигуратора(Знач КомандаКонфигуратора, ПодавлятьДиалоги = Истина)
